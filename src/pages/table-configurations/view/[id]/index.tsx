...
import { getTableConfigurationById } from 'apiSdk/table-configurations';
...
function TableConfigurationViewPage() {
  ...
  return (
    <AppLayout>
      <Text as="h1" fontSize="2xl" fontWeight="bold">
        Table Configuration Detail View
      </Text>
